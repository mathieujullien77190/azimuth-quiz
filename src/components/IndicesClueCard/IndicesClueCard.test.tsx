...
describe('IndicesClueCard — revealed content per clue', () => {
  ...
  it('letter: stage 2 on a multi-word name shows the real per-word length ("New York" -> "N__", "____")', async () => {
    ...
    expect(getByText('N__')).toBeTruthy();
    expect(getByText('____')).toBeTruthy();
  });
